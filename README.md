...
The data in the presentation matches the current ShipCheck public report and README at build time: score `67`, tier `ALMOST`, RED distribution plan, AMBER retention strategy, GREEN user definition, and the Question 12 Novus story from the seeded report.
